...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    if (currentUser) {
      ...
      // if (currentUser.roleNames.includes('admin') || currentUser.roleNames.includes('Admin')) {
      //     // Register the navigation to the service
      //     this._fuseNavigationService.register('main', adminNavigation);
      //     this._fuseNavigationService.setCurrentNavigation('main');
      // } else if (currentUser.roleNames.includes('user') || currentUser.roleNames.includes('User')) {
      //     // Register the navigation to the service
      //     this._fuseNavigationService.register('user', userNavigation);
      //     this._fuseNavigationService.setCurrentNavigation('user');
      // } else {
      //     // Register the navigation to the service
      //     this._fuseNavigationService.register('officer', officerNavigation);
